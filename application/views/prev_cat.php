<!DOCTYPE html>
    ...
    <head>
    	...
    	<?php foreach ($isi as $data) { ?>
			<tr>
				<td colspan="2"><h1 class="mb-10"><?php echo $data['id_ktg']; ?></h1></td>
            </tr> 
             <tr>
                <p><td><?php echo $data['deskripsi']; ?> </td></p>
                <p><td><?php echo $data['keterangan']; ?></td></p>
            </tr>
            <p><a href="<?php echo base_url()."kategori/edit/".$data['id']; ?>">Update</a></p>
